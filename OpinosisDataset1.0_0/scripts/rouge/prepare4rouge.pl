...
#
# @SEE  examples/prepare4rouge/ for sample input and output to get a better idea. Instructions on how to use rouge can be found here http://kavita-ganesan.com/rouge-howto
#
#
